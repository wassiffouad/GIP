        ...
        <div class="container">
            ...
            <form method="post" action="wachtwoord.php">
                <div class="form-group">
                    <input type="password" name="nieuw" id="input" placeholder="nieuw wachtwoord" required="required"/>
                </div>
                <div class="form-group">
                    <input type="password" name="nieuw1" placeholder="bevestig wachtwoord" required="required"/>
                </div>
                <div class="form-group">
                    <input type="password" name="oud" placeholder="oud wachtwoord" required="required"/>
                </div>
                <a class="forgot-pwd underline" title="" href="#">Forgot Password?</a>
                <div class="submit-btns">
                    <button type="button"  class="btn btn-primary"><span>Cancel</span></button>
                    <button type="submit" name="knop" class="btn btn-primary"><span>Update</span></button>
                </div>
            </form>
        </div>
    </div>
